...
function FaceInfoDetailBottomSheet({ isOpen, onClose }: HandleBottomSheetProps) {
    ...
    <BottomSheet isOpen={isOpen} onChange={onClose}>
      <Container direction="column" gap="60px">
        ...
        <Container direction="column" gap="40px" css={scrollContainerStyle}>
          <Heading.H4 weight="semi-bold">바이오(얼굴) 정보 수집, 이용 동의</Heading.H4>
          <Paragraph>
...
export default FaceInfoDetailBottomSheet;
