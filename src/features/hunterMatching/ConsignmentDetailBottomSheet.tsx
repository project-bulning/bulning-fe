...
function ConsignmentDetailBottomSheet({ isOpen, onClose }: HandleBottomSheetProps) {
    ...
    <BottomSheet isOpen={isOpen} onChange={onClose}>
      <Container direction="column" gap="60px">
        ...
        <Container direction="column" gap="40px" css={scrollContainerStyle}>
          <Heading.H4 weight="semi-bold">업무위수수탁약관</Heading.H4>
          <Paragraph>
...
export default ConsignmentDetailBottomSheet;
