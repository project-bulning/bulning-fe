...
function ThirdPartyDetailBottomSheet({ isOpen, onClose }: HandleBottomSheetProps) {
    ...
    <BottomSheet isOpen={isOpen} onChange={onClose}>
      <Container direction="column" gap="60px">
        ...
        <Container direction="column" gap="40px" css={scrollContainerStyle}>
          <Heading.H4 weight="semi-bold">개인정보 제3자 제공에 대한 동의</Heading.H4>
          <Paragraph>
...
export default ThirdPartyDetailBottomSheet;
